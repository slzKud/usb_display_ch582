...
int main()
{
    ...
    //pU2EP0_RAM_Addr = U2EP0_Databuf;    //配置缓存区64字节。
    ...
    //u8g2_Setup_ssd1306_i2c_128x64_noname_f(&u8g2, U8G2_R0, u8x8_byte_sw_i2c, u8x8_gpio_and_delay_soft_i2c_ch58x);  // 初始化 u8g2 结构体 SOFTI2C
    u8g2_Setup_ssd1306_i2c_128x64_noname_f(&u8g2, U8G2_R0, u8x8_byte_hw_i2c, u8x8_gpio_and_delay_hw);  // 初始化 u8g2 结构体 HARDI2C
