...
#ifndef CH58X_SPI_REMAP 
#define W25Qx_Enable() 			GPIOA_ResetBits(SCS_PIN)
#define W25Qx_Disable() 		GPIOA_SetBits(SCS_PIN)
#else
#define W25Qx_Enable() 			GPIOB_ResetBits(SCS_PIN)
#define W25Qx_Disable() 		GPIOB_SetBits(SCS_PIN)
#endif
